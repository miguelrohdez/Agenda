...
<html lang="es-ES">
	...
	<div class="container">
		...
		<div class="caja principal">
					...
					<tr>
					<td id="txt_advertencia" colspan="2"> Contraseña Incorrecta </td>
					</tr>
					<tr>
						<td class='btn_registro'><a href='./index.php'><button>Ir a Calendario</button></a></td>
						<td class='btn_registro'><a href='./consultar.php'><button>Reintentar</button></a></td>
					</tr>
				</table>";
		</div>
